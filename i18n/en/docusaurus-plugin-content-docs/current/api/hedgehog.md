...
[Github](https://github.com/AsixProject/hedgehog) 👈  
...
```bash
npm i --save @asix/hedgehog
```

### Docs & Examples

Check out our full technical [docs](http://asixproject.github.io/hedgehog-docs) and [api how-to](http://asixproject.github.io/hedgehog-docs#how-to).

For a quick browser-side demo, [look no further](https://codesandbox.io/embed/pp9zzv2n00). For a full end-to-end auth demonstration, see our [demo repo](https://github.com/asixproject/asix-hedgehog-demo).
...
### 👉 [Take a deeper dive into the docs](https://asixproject.github.io/hedgehog-docs/#installation) 👈
