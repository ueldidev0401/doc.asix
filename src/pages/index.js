                  ...
                  <div className="card__body">
                    <p>
                      <Translate description="get-an-overview">
                        Get an overview of what Asix+ is, how it works, and how you can contribute
                      </Translate>
                    </p>
                  </div>
                </div>
                  ...
                  <div className="card__body">
                    <p>
                      <Translate description="serve-traffic">
                        Get up and running and serve traffic for the Asix+ network
                      </Translate>
                    </p>
                  </div>
                </div>
...
const Index = () => {
  ...
  return (
    <Layout title="Home" description="Asix+ Docs">
      <Main />
    </Layout>
  );
}
